...
create table manhattan_test.user_demand_model_event_seq2_20200710_20200810_spark_2 as 

select
    uid, tel, server_date, label, 
    collect_list(loan_chain) as loan_chain_string
from 
    (
        select
                ...
                from             
                                ...
                                from
                                    (
                                        ...
                                        (
                                            select
                                                tel, server_date,
                                                max(dsd_market_biopen) as dsd_market_biopen,
                                                max(dsd_market_setup_sw) as dsd_market_setup_sw,
                                                max(dsd_mycoupon_ck) as dsd_mycoupon_ck,
                                                max(dsd_loan_list_sw) as dsd_loan_list_sw,
                                                max(dsd_loan_page_show) as dsd_loan_page_show,
                                                max(dsd_loan_confirm_button_ck) as dsd_loan_confirm_button_ck,
                                                max(dsd_input_pay_password_popup) as dsd_input_pay_password_popup,
                                                max(dsd_face_rec) as dsd_face_rec,
                                                max(dsd_loan_apply_submit_api_done) as dsd_loan_apply_submit_api_done
                                                ...
                                                (
                                                    ...
                                                    from
                                                        (
                                                            ...
                                                            where
                                                                concat_ws('-', year, month, day) between add_months('2020-07-10', -6) and '2020-08-10'
                                                                and eventid in (
                                                                    'market_biopen',
                                                                    'market_setup_sw',
                                                                    'market_loan_list_sw',
                                                    ...
                                                    where
                                                        to_date(server_time) between add_months('2020-07-10', -6) and '2020-08-10'
                                                    group by
                                                        tel,
                                                        eventid,
                                                        dsd_market_biopen,
                    ...
                    (
                        ...
                        select
                            ...
                            t0.cfrnid,
                            t0.success_time,
                            t0.interest_rate as current_drip_interest_rate,
                            t0.stat_date, 
                    ...
                    on t0.uid= t1.uid and t0.node_server_date = date_add(t1.stat_date, 1)
