...
hive -e "
drop table if exsist manhattan_test.user_demand_model_event_seq2_${start_pt}_${end_pt};
create table manhattan_test.user_demand_model_event_seq2_${start_pt}_${end_pt} as 
